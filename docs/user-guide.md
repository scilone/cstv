...
* **Nouvelle fiche film sur TV (F28)** : Sur téléviseur, la fiche d'un film adopte une présentation cinéma pleine page. L'affiche s'affiche en grand sur toute la moitié gauche de l'écran et se fond dans le décor ; à droite viennent le titre, l'année, les genres, la durée et la note, le résumé, puis les noms cliquables du réalisateur et des acteurs. Juste en dessous, trois actions côte à côte — ajouter aux favoris, j'aime, je n'aime pas — précèdent le grand bouton « LIRE LE FILM » (ou « REPRENDRE LA LECTURE » puis « RELIRE DEPUIS LE DÉBUT » si vous aviez déjà commencé le film). À l'ouverture, la télécommande pointe directement sur ce bouton : un simple appui sur OK lance le film. La rangée « Titres associés » affleure en bas de l'écran ; descendez d'un cran et tout le contenu remonte pour la révéler entièrement. Le cadre de sélection s'y pose sur la première affiche et n'en bouge plus : ce sont les vignettes qui défilent dessous, comme partout ailleurs dans l'application. Un nouvel appui vers le haut ramène la fiche à sa position d'origine. Si le résumé est trop long pour la place disponible, il est coupé et une action **« VOIR PLUS »** l'ouvre en entier dans une fenêtre ; la fiche reste intacte derrière et la touche Retour referme la fenêtre. Pour les films qui en ont un, la bande-annonce se lance dans le grand emplacement de l'affiche, à gauche, et non plus en fond de toute la page.
